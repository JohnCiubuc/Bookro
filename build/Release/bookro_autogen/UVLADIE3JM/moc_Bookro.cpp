...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Bookro_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Bookro_t qt_meta_stringdata_Bookro = {
    {
QT_MOC_LITERAL(0, 6) // "Bookro"
...
const QMetaObject Bookro::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_Bookro.offsetsAndSize,
    qt_meta_data_Bookro,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Bookro_t
, QtPrivate::TypeAndForceComplete<Bookro, std::true_type>
